...
public class BeerController {
    ...
    public List<BeerDto> listBeers(@RequestParam(name = "beerName", required = false) String beerName,
        ...
        if (StringUtils.hasText(beerName) && beerStyle != null) {
            beers = beerService.listBeersByNameAndStyle(beerName, beerStyle, pageNumber, pageSize);
        } else if (StringUtils.hasText(beerName)) {
            beers = beerService.listBeersByNameContainingIgnoreCase(beerName, pageNumber, pageSize);
        } else if (beerStyle != null) {
            beers = beerService.listBeersByStyle(beerStyle, pageNumber, pageSize);
        } else {
            beers = beerService.listBeers(pageNumber, pageSize);
        }
