...
public class BeerOrderEntity {
    ...
    public BeerOrderEntity(UUID id, Long version, Timestamp createdDate, Timestamp lastModifiedDate,
                           String customerRef, CustomerEntity customer, BigDecimal paymentAmount,
                           Set<BeerOrderLineEntity> beerOrderLines, BeerOrderShipmentEntity beerOrderShipment) {
        this.id = id;
    ...
    // Para disparar el flujo de trabajo de los microservicios
